...
class LForm {
    ...
    public static function id() {
        return trans('albums/form.id');
    } 
                                                
    public static function nomeAlbum() {
        return trans('albums/form.nome_album');
    } 
                                                
    public static function songCount() {
        return trans('albums/form.song_count');
    } 
                                                
    public static function totalLength() {
        return trans('albums/form.total_length');
    } 
                                                
    public static function createdAt() {
        return trans('albums/form.created_at');
    } 
                                                
    public static function actions() {
        return trans('albums/form.actions');
    } 
