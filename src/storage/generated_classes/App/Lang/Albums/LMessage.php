...
class LMessage {
    ...
    public static function albumNotFound() {
        return trans('albums/message.album_not_found');
    } 
                                                
    public static function success_newAlbumsFound() {
        return trans('albums/message.success.new_albums_found');
    } 
                                                
    public static function info_noAlbumsFound() {
        return trans('albums/message.info.no_albums_found');
    } 
