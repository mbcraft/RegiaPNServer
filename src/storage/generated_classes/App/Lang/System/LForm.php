...
class LForm {
    ...
    public static function serviceName() {
        return trans('system/form.service_name');
    } 
                                                
    public static function serviceStatus() {
        return trans('system/form.service_status');
    } 
                                                
    public static function services_backgroundScanAndEncoding_label() {
        return trans('system/form.services.background_scan_and_encoding.label');
    } 
                                                
    public static function services_backgroundScanAndEncoding_values_0() {
        return trans('system/form.services.background_scan_and_encoding.values.0');
    } 
                                                
    public static function services_backgroundScanAndEncoding_values_1() {
        return trans('system/form.services.background_scan_and_encoding.values.1');
    } 
                                        
    public static function services_backgroundScanAndEncoding_values() {
        return self::__values('system/form.services.background_scan_and_encoding.values',func_get_args());
    }
                                
    public static function services_backgroundScanAndEncoding_error() {
        return trans('system/form.services.background_scan_and_encoding.error');
    } 
