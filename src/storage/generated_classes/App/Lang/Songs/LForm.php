...
class LForm {
    ...
    public static function id() {
        return trans('songs/form.id');
    } 
                                                
    public static function albumId() {
        return trans('songs/form.album_id');
    } 
                                                
    public static function albumNameId() {
        return trans('songs/form.album_name_id');
    } 
                                                
    public static function nomeCanzone() {
        return trans('songs/form.nome_canzone');
    } 
                                                
    public static function metadataStatus_label() {
        return trans('songs/form.metadata_status.label');
    } 
                                                
    public static function metadataStatus_values_NOT_FETCHED() {
        return trans('songs/form.metadata_status.values.NOT_FETCHED');
    } 
                                                
    public static function metadataStatus_values_NOT_FOUND() {
        return trans('songs/form.metadata_status.values.NOT_FOUND');
    } 
                                                
    public static function metadataStatus_values_FOUND() {
        return trans('songs/form.metadata_status.values.FOUND');
    } 
                                        
    public static function metadataStatus_values() {
        return self::__values('songs/form.metadata_status.values',func_get_args());
    }
                                
    public static function crypted_label() {
        return trans('songs/form.crypted.label');
    } 
                                                
    public static function crypted_0() {
        return trans('songs/form.crypted.0');
    } 
                                                
    public static function crypted_1() {
        return trans('songs/form.crypted.1');
    } 
                                                
    public static function title() {
        return trans('songs/form.title');
    } 
                                                
    public static function genre() {
        return trans('songs/form.genre');
    } 
                                                
    public static function artist() {
        return trans('songs/form.artist');
    } 
                                                
    public static function album() {
        return trans('songs/form.album');
    } 
                                                
    public static function track() {
        return trans('songs/form.track');
    } 
                                                
    public static function date() {
        return trans('songs/form.date');
    } 
                                                
    public static function duration() {
        return trans('songs/form.duration');
    } 
                                                
    public static function bitrate() {
        return trans('songs/form.bitrate');
    } 
                                                
    public static function createdAt() {
        return trans('songs/form.created_at');
    } 
                                                
    public static function actions() {
        return trans('songs/form.actions');
    } 
                                                
    public static function crypted_values_0() {
        return trans('songs/form.crypted.values.0');
    } 
                                                
    public static function crypted_values_1() {
        return trans('songs/form.crypted.values.1');
    } 
                                        
    public static function crypted_values() {
        return self::__values('songs/form.crypted.values',func_get_args());
    }
                                
    public static function listen() {
        return trans('songs/form.listen');
    } 
                                                
    public static function addTrack() {
        return trans('songs/form.add_track');
    } 
                                                
    public static function trackType() {
        return trans('songs/form.track_type');
    } 
                                                
    public static function errors() {
        return trans('songs/form.errors');
    } 
                                                
    public static function fileNotFound() {
        return trans('songs/form.file_not_found');
    } 
