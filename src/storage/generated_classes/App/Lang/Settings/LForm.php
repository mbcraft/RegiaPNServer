...
class LForm {
    ...
    public static function id() {
        return trans('settings/form.id');
    } 
                                                
    public static function key() {
        return trans('settings/form.key');
    } 
                                                
    public static function value() {
        return trans('settings/form.value');
    } 
                                                
    public static function context() {
        return trans('settings/form.context');
    } 
                                                
    public static function createdAt() {
        return trans('settings/form.created_at');
    } 
                                                
    public static function actions() {
        return trans('settings/form.actions');
    } 
                                                
    public static function editable_label() {
        return trans('settings/form.editable.label');
    } 
                                                
    public static function editable_values_0() {
        return trans('settings/form.editable.values.0');
    } 
                                                
    public static function editable_values_1() {
        return trans('settings/form.editable.values.1');
    } 
                                        
    public static function editable_values() {
        return self::__values('settings/form.editable.values',func_get_args());
    }
                                
    public static function updatedAt() {
        return trans('settings/form.updated_at');
    } 
