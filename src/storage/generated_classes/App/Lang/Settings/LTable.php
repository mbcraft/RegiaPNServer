...
class LTable {
    ...
    public static function create() {
        return trans('settings/table.create');
    } 
                                                
    public static function edit() {
        return trans('settings/table.edit');
    } 
                                                
    public static function show() {
        return trans('settings/table.show');
    } 
                                                
    public static function list_() {
        return trans('settings/table.list');
    } 
                                                
    public static function noEntities() {
        return trans('settings/table.no_entities');
    } 
