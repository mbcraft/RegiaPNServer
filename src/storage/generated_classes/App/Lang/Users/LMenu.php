...
class LMenu {
    ...
    public static function root() {
        return trans('users/menu.root');
    } 
                                                
    public static function list_() {
        return trans('users/menu.list');
    } 
                                                
    public static function new_() {
        return trans('users/menu.new');
    } 
                                                
    public static function profile() {
        return trans('users/menu.profile');
    } 
                                                
    public static function create() {
        return trans('users/menu.create');
    } 
                                                
    public static function show() {
        return trans('users/menu.show');
    } 
                                                
    public static function edit() {
        return trans('users/menu.edit');
    } 
