...
class LMenu {
    ...
    public static function root() {
        return trans('players/menu.root');
    } 
                                                
    public static function show() {
        return trans('players/menu.show');
    } 
                                                
    public static function list_() {
        return trans('players/menu.list');
    } 
                                                
    public static function create() {
        return trans('players/menu.create');
    } 
                                                
    public static function edit() {
        return trans('players/menu.edit');
    } 
