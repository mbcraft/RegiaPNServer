...
class LPages {
    ...
    public static function create() {
        return trans('players/pages.create');
    } 
                                                
    public static function list_() {
        return trans('players/pages.list');
    } 
                                                
    public static function show() {
        return trans('players/pages.show');
    } 
                                                
    public static function edit() {
        return trans('players/pages.edit');
    } 
                                                
    public static function updatePackageGenerationResult() {
        return trans('players/pages.update_package_generation_result');
    } 
