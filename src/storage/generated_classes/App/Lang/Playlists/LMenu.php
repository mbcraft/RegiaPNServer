...
class LMenu {
    ...
    public static function root() {
        return trans('playlists/menu.root');
    } 
                                                
    public static function show() {
        return trans('playlists/menu.show');
    } 
                                                
    public static function list_() {
        return trans('playlists/menu.list');
    } 
                                                
    public static function create() {
        return trans('playlists/menu.create');
    } 
                                                
    public static function edit() {
        return trans('playlists/menu.edit');
    } 
