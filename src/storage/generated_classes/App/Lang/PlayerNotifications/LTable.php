...
class LTable {
    ...
    public static function general() {
        return trans('player_notifications/table.general');
    } 
                                                
    public static function list_() {
        return trans('player_notifications/table.list');
    } 
                                                
    public static function show() {
        return trans('player_notifications/table.show');
    } 
                                                
    public static function noEntities() {
        return trans('player_notifications/table.no_entities');
    } 
