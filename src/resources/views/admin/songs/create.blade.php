                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="position-center">
                            ...
                            <form role="form" id="tryitForm" class="form-horizontal" enctype="multipart/form-data" method="POST" action="{{ route('customers.create') }}">
                                {!! Form::token() !!}
                                <div class="cd-block">
                                ...
                                <div class="cd-block">
                                    <div class="cd-content">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder=" " id="phone" name="phone" class="form-control" value="{!! Input::old('phone') !!}" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <textarea rows="5" cols="30" class="form-control" id="address" name="address"> {!! Input::old('address') !!}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder=" " id="zip" class="form-control" name="zip"  value="{!! Input::old('zip') !!}" />
                                                </div>
                                            </div>
                                        </div>
