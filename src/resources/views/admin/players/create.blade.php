                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="position-center">
                            ...
                            <form role="form" class="form-horizontal" action="<?= Routes::admin_players_create_do() ?>" enctype="multipart/form-data" method="POST">
                                <input type="hidden" name="cliente_id" value="<?= $cliente_id ?>" />
                                @include("admin/players/_form",["player" => (new Player())->withNewPasswordApi()->withDefaultTimeZone()->withDefaultCountry(),"create" => true])
